...
//        password1 = intent.getStringExtra("password1");
        ...
        //In the OnCreate() method, intialize the Firebase Auth instance.
...
//        mPasswordEt.setText(password1);
    ...
    private void showRecoverPasswordDialog() {
        ...
        /*sets the main width of EditView to fit a text of n "M" letters regardless
        * of actual text extension and text size  */
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            //if user is signing in first time then get and show
