    ...
    public void onBindViewHolder(@NonNull final HolderNotification holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("postId", pId);// will get detail of post using this id,which is of the clicked post
                        ...
                        ref.child(firebaseAuth.getUid()).child("Notifications").child(timestamp)
                                ...
                                .addOnFailureListener(new OnFailureListener() {
                                    ...
                                    public void onFailure(@NonNull Exception e) {
                                        //failed
                                        Toast.makeText(context, "cancel"+e.getMessage(), Toast.LENGTH_SHORT).show();
                                    }
                                });
                    }
                });
